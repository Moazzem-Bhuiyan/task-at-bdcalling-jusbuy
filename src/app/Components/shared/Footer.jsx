...
'>
  ...
  <aside>
  <Image src='/footer.png' className='w-[150px] mb-5' width={100} height={50} alt='logo'/>
  ...
  <nav className='flex flex-col space-y-5 text-neutral-300 py-11 md:py-0'>
    ...
    <Link href='/privecy'><h1 className=" link-hover">privacy & Policy</h1></Link>
  ...
  <h6 className="text-2xl text-white">Help & Support</h6>
    <a className=" link-hover flex gap-2  text-xl font-medium"><CiMail className='text-3xl'/>Email: <div ><span>tiyonbhuiyan.201@gmailcom</span><br /><span>custom@gmailcom</span></div></a>
    <a className=" link-hover flex gap-2 text-xl font-medium"><FiPhone className='text-3xl'/>Phone: <div ><span>+8801820921814</span><br /><span>+8801820921814</span></div></a>
